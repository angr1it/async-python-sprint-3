...
class SendRequests(Enum):
    ...
    SEND_JSON_RESP = {
        'action': CommandType.send, 'success': True, 'reason': '', 'datetime':  test_dt, 'user': 'andre', 'room_name': 'Global', 
...
class HistoryRequests(Enum):
    ...
    HISTORY_USER_DEFAULT_USER_JSON_RESP = {
        'action': CommandType.history, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'andre', 
        'payload': { 'history': [
            {'action': CommandType.create_room, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'andre', 'payload': {'room_name': 'open_room'}}]}
    }

class RegisterRequests(Enum):
    REGISTER_COMMAND = 'user1 123'
    REGISTER_JSON_REQ = {'command': '/register', 'username': 'user1', 'password': '123'}
    REGISTER_JSON_RESP = {'action': CommandType.register, 'datetime': test_dt, 'success': True, 'reason': '', 'payload': {'user_name': 'user1'}}
...
class LoginRequests(Enum):
    ...
    LOGIN_JSON_RESP = {'action': CommandType.login, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'user1', 'payload': {}}
    LOGIN_JSON_RESP_BAD = {'action': CommandType.login, 'success': False, 'reason': 'Incorrect username or password.', 'datetime': test_dt, 'user': 'anonymus_12314', 'payload': {}}
    LOGIN_JSON_RESP_AGAIN = {'action': CommandType.login, 'success': False, 'reason': 'Already logged in.', 'datetime': test_dt, 'user': 'user1', 'payload': {}}
...
class CreateOpenRoomRequests(Enum):
    ...
    CREATE_JSON_RESP_ANON = {'action': CommandType.create_room, 'success': False, 'reason': 'Not authorized.', 'datetime': test_dt, 'user': 'anonymus_12314', 'payload': {'room_name': 'open_room'}}
    CREATE_JSON_RESP_SUCCESS = {'action': CommandType.create_room, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'user1', 'payload': {'room_name': 'open_room'}}
    
    DELETE_COMMAND = 'open_room'
    DELETE_JSON_REQ = {'command': CommandType.delete_room, 'room_name': 'open_room'}
    DELETE_JSON_RESP_ANON = {'action': CommandType.delete_room, 'success': False, 'reason': 'Not authorized.', 'datetime': test_dt, 'user': 'anonymus_12314', 'payload': {'room_name': 'open_room'}}
    DELETE_JSON_RESP_SUCCESS = {'action': CommandType.delete_room, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'user1', 'payload': {'room_name': 'open_room'}}

class JoinOpenRequests(Enum):
    COMMAND = 'open_room'  
    REQ = {'command': CommandType.join_room, 'room_name': 'open_room'}
    RESP_ANON = {'action': CommandType.join_room, 'success': False, 'reason': 'Not allowed to join this room.', 'datetime': test_dt, 'user': 'anonymus_12314', 'payload': {'room_name': 'open_room'}}
    RESP_SUCESS = {'action': CommandType.join_room, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'user2', 'payload': {'room_name': 'open_room'}}
...
class RestrictedRoomRequests(Enum):
    ...
    CREATE_ROOM_RESP_SUCCESS = {'action': CommandType.create_room, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'user1', 'payload': {'room_name': 'restricted_room'}}
    ADD_USER_RESP_NOT_ALLOWED = {'action': CommandType.add_user, 'success': False, 'reason': 'Not allowed.', 'datetime': test_dt, 'user': 'user2', 'payload': {'room_name': 'restricted_room', 'new_user': 'user2'}}
    ADD_USER_RESP_NO_AUTH = {'action': CommandType.add_user, 'success': False, 'reason': 'Not authorized.', 'datetime': test_dt, 'user': 'anonymus_12314', 'payload': {'room_name': 'restricted_room', 'new_user': 'user2'}}
    ADD_USER_RESP_SUCCESS = {'action': CommandType.add_user, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'user1', 'payload': {'room_name': 'restricted_room', 'new_user': 'user2'}}
    ...
    JOIN_RESP_SUCCESS = {'action': CommandType.join_room, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'user2', 'payload': {'room_name': 'restricted_room'}}
    REMOVE_USER_RESP_ANON = {'action': CommandType.remove_user, 'success': False, 'reason': 'Not allowed.', 'datetime': test_dt, 'user': 'anonymus_12314', 'payload': {'room_name': 'restricted_room', 'remove_user': 'user2'}}
    REMOVE_USER_RESP_SUCCESS = {'action': CommandType.remove_user, 'success': True, 'reason': '', 'datetime': test_dt, 'user': 'user1', 'payload': {'room_name': 'restricted_room', 'remove_user': 'user2'}}
